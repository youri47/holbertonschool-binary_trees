...
int main(void)
{
	...
	/* Test sur la racine (pas une feuille) */
	ret = binary_tree_is_leaf(root);
	printf("Nœud 98 (racine) est une feuille: %d\n", ret);

	/* Test sur un nœud interne (pas une feuille) */
	ret = binary_tree_is_leaf(root->left);
	printf("Nœud 12 (interne) est une feuille: %d\n", ret);

	/* Test sur des feuilles */
	ret = binary_tree_is_leaf(root->left->left);
	printf("Nœud 6 (feuille) est une feuille: %d\n", ret);

	ret = binary_tree_is_leaf(root->left->right);
	printf("Nœud 56 (feuille) est une feuille: %d\n", ret);

	ret = binary_tree_is_leaf(root->right->left);
	printf("Nœud 256 (feuille) est une feuille: %d\n", ret);

	ret = binary_tree_is_leaf(root->right->right);
	printf("Nœud 512 (feuille) est une feuille: %d\n", ret);

	/* Test avec NULL */
	ret = binary_tree_is_leaf(NULL);
	printf("NULL est une feuille: %d\n", ret);
